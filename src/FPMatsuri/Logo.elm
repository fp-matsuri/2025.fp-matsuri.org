module FPMatsuri.Logo exposing (logoMark, logoMarkWithOptions)

import Html.Attributes exposing (attribute)
import Svg exposing (Svg, defs, g, linearGradient, path, rect, stop, svg)
import Svg.Attributes exposing (d, fill, gradientTransform, gradientUnits, height, id, offset, rx, ry, stopColor, viewBox, width, x, x1, x2, xlinkHref, y, y1, y2)
