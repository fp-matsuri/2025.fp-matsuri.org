...
const Overview = () => {
  ...
  return (
    <Block title="Overview">
      <div className="md:flex flex-wrap justify-between gap-x-8">
...
const Schedule = () => {
  ...
  return (
    <Block title="Schedule">
      <ul>
        {events.map((eee, i) => (
          <li>{eee.event}{eee.at}</li>
        ))}
      </ul>
      <p>記載されているスケジュールの一部は予告なく変更されることがございます。</p>
    </Block>
  )
};
...
const Sponsors = () => (
  <Block title="Sponsors">
    <div className="border border-black rounded-xl px-8">
